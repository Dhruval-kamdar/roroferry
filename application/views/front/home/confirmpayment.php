        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <section id="first-tab-group" class="tabgroup">
                    <form method='post' action='<?= base_url() . 'makePayment'; ?>' id='paynow'>
                        <div id="tab1">
                            <!--Step 1-->
                            ...
                            <div class="submit-form form1 ">
                                ...
                                <div class="row ">
                                    <div class="col-md-12 hidden">
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <input type="text" class="firstname form-control"  id="firstname" name="firstname" placeholder="Enter your first name" autocomplete="off" value="<?= $details['firstname']; ?>">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <input type="text" class="lastname form-control"  id="lastname" name="lastname" placeholder="Enter your last name" autocomplete="off" value="<?= $details['lastname']; ?>">
                                                <label for="fromstaton" class="error"></label>
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 hidden">
                                        <div class="col-md-12">
                                            <fieldset>
                                                ...
                                                <input type="text" class="emailAddress form-control"  id="email" name="email" placeholder="Enter your email address" autocomplete="off" value="<?= $details['email']; ?>">
                                                <label for="fromstaton" class="error"></label>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <fieldset>
                                                ...
                                                <input type="text" class="amount form-control"  id="amount" name="amount" placeholder="Enter your amount" autocomplete="off" value="<?= $details['amount']; ?>">
                                                <label for="fromstaton" class="error"></label>
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 hidden">
                                        <div class="col-md-12">
                                            <fieldset>
                                                ...
                                                <input type="text" class="mobileno form-control"  id="mobileno" name="mobileno" placeholder="Enter your mobile number" autocomplete="off" value="<?= $details['mobileno']; ?>">
                                                <label for="fromstaton" class="error"></label>
                                            </fieldset>
                                        </div>
                                    ...
                                    <div class="col-md-12 hidden">
                                        <div class="col-md-12">
                                                <fieldset>
                                                    ...
                                                    <textarea class="note form-control"  style="margin-left:8px" id="note" name="note" placeholder="Describe your payment details here..." autocomplete="off"><?= $details['note']; ?></textarea>
                                                     <label for="fromstaton" class="error"></label>
                                                </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <fieldset>
                                                <label for="from">First name :&nbsp; <?= $details['firstname']; ?></label>
                                            </fieldset>
                                        </div>
                                        
                                        <div class="col-md-12">
                                            <fieldset>
                                                <label for="from">Last name :&nbsp; <?= $details['lastname']; ?></label>
                                            </fieldset>
                                        </div>
                                        
                                        <div class="col-md-12">
                                            <fieldset>
                                                <label for="from">Email Address :&nbsp; <?= $details['email']; ?></label>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-12">
                                            <fieldset>
                                                <label for="from">Amount :&nbsp; <?= $details['amount']; ?></label>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-12">
                                            <fieldset>
                                                <label for="from">Mobile Number :&nbsp; <?= $details['mobileno']; ?></label>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-12">
                                            <fieldset>
                                                <label for="from">Note :&nbsp; <?= $details['note']; ?></label>
                                            </fieldset>
                                        </div>
                                    </div>
