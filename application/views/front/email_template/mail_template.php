    ...
    <div style="padding: 48px;">
        <div style="width: 560px; margin: 0 auto; display: block; box-shadow: 0px 0px 14px 0px rgba(142, 140, 140, 0.67); background: #fff; padding: 48px;">
            ...
            <div style="background: linear-gradient(#fff,rgba(222, 13, 0, 0.16)); box-shadow: 0px 0px 16px 0px rgba(0, 0, 0, 0.33); padding: 16px;">
                <!-- Contnt start -->
                <h3 style="margin-top: 10px;font-family: sans-serif;">Dear DDD </h3>
                <!-- <h3 style="margin-top: 30px;">Hello ,</h3> -->
                <p style ="font-size:16px; font-family: sans-serif; margin-top:30px;line-height: 24px;">You have successfully created account with DDD</p>
                ...
                <p style="font-size:16px; margin-top:40px;line-height: 24px;font-family: sans-serif;">ddd</p>
                <br>
